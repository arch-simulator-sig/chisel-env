...
class StoreQueue extends Module with nanshanConfig {
  ...
  val io = IO(new Bundle {
    ...
    // to data cache
    val out_st = new CacheBusIO   // id = nanshanConfig.SqStoreId
    val out_ld = new CacheBusIO   // id = nanshanConfig.SqLoadId
